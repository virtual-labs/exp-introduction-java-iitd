...
<b> Experiment|  <b> 1. Introduction to Java.
...
#### Experimentation
The lab will focus on the process of writing java programming code including the syntax and methods used for creating basic java programs.
#### Learn from failure
...
:--|:--|:--|:-:
1.| Student will be able to: <br>describe the structure of basic java program.<br> | Understand| Describe
2.| Student will be able to: <br>identify different components of a java program<br> | Apply| Identify
3.| Student will be able to: <br>develop a basic java program to display Hello World | Create| Develop
...
:--|:--|:--|:--
1.| Student will be able to describe the structure of basic java program. | Select the text editor for your java program. | Q Which of the following is a Text Editor? <br>a) MS Powerpoint<br>b) <b>Notepad</b><br>c) Flash <br>d) Google Chrome
2.| Student will be able to identify different components of a java program.| Demonstrate the working of println() method. | Q println() is a method of print stream class <br><b>a) True </b><br>b) False
3.| Student will be able to develop a basic java program to display Hello World.| Construct a java program for displaying given output. | Q Which extension is used for saving a java program ? <br><b> A. .program </b><br> B. .class <br> C. .exe <br>D. .java
